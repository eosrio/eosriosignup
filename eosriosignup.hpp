...
class eosriosignup: public contract {
public:
    eosriosignup(account_name self): contract(self){};
...
private:
  ...
  typedef multi_index<N(rammarket), exchange_state> rammarket_t;
};
...
EOSIO_ABI_EX(eosriosignup, (transfer))
